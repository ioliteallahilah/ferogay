...
<div class="ui inverted segment">
  <div class="ui inverted form">
	...
	<div class="field" id="botname">
        <label>Name</label>
        <div class="ui large labeled input"><input type="text" value="${params.get('name') || "ferobackBABY"}" placeholder="Nickname" maxlength="18" spellcheck="false" data-ms-editor="true"></div>
      </div>
      <div class="field">
        <label>Room</label>
      ...
      <div class="field" id="botamount">
        ...
        <div class="ui large labeled input"><input type="number" value="${params.get('amount') || "yarram"}" min="1" max="20"></div>
      </div>
    </div>
...
<div class="ui fluid selection profil bot-image dropdown" tabaindex="0">
  ...
  <div class="text"><img class="ui avatar image" src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwallpapercave.com%2Fw%2Fuwp1073354&psig=AOvVaw0Y8zqVGZIMUdcFILfY_wLb&ust=1690383872881000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCNiL8Yb5qYADFQAAAAAdAAAAABAF">Default</div>
...
<div class="field"><div class="ui labeled input" id="messagetext"><input type="text" value="${params.get('message-text') || "ferobackBABY"}" placeholder="Message text" maxlength="1000" spellcheck="false" data-ms-editor="true"></div></div><div class="field">
      ...
      try {
        ...
        if (people) {
          ...
          if (regex.test(username)) {
            document.querySelector('#botname div input').value = "ferobackBABY";
            username = "";
          }
        }
        ...
        case 11: {
          if (!messageSent) {
            ...
            if (data[2] === "paylaş") {
              ...
              socket.send(`42[11,"${playerId}","heyyoallah"]`);
            }
...
document.querySelector("#send").addEventListener("click", function () {
  ...
  if (regex.test(messagetext)) {
    document.querySelector('#messagetext input').value = "hiiki";
    messagetext = "hiiki";
  }
    ...
    socketList.forEach((socket) => {
      if (socket.readyState === WebSocket.OPEN) {
        ...
        if (regex.test(spamtext)) {
          document.querySelector('#spamtext input').value = "hiiki";
          spamtext = "hiiki";
        }
